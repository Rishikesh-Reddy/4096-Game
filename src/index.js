    ...
    if (!this.state.gameOver && !this.state.won) {
      if (direction === "up") {
        ...
        if (this.boardMoved(this.state.board, movedUp.board)) {
          ...
          else if( this.checkGameWon(upWithRandom)){
            this.setState({
              board: upWithRandom,
              gameOver: true,
              won: true,
        ...
        if (this.boardMoved(this.state.board, movedRight.board)) {
          ...
          } else if( this.checkGameWon(rightWithRandom)){
            this.setState({
              board: rightWithRandom,
              gameOver: true,
              won: true,
        ...
        if (this.boardMoved(this.state.board, movedDown.board)) {
          ...
          } else if( this.checkGameWon(downWithRandom)){
            this.setState({
              board: downWithRandom,
              gameOver: true,
              won: true,
        ...
        if (this.boardMoved(this.state.board, movedLeft.board)) {
          ...
          } else if( this.checkGameWon(leftWithRandom)){
            this.setState({
              board: leftWithRandom,
              gameOver: true,
              won: true,
